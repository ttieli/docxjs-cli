    ...
    for (let i = 0; i < tokens.length; i++) {
        ...
        // --- Math Block ($$...$$) ---
            ...
            try {
                ...
                if (result && result.buffer) {
                    ...
                    console.log(`  -> Added Math Block as Image (${Math.round(width)}x${Math.round(height)} px)`);
                } else {
            ...
            if (token.info === 'mermaid') {
                ...
                try {
                    ...
                    if (buffer) {
                        ...
                        console.log(`  -> Added Mermaid Diagram as Image (${width}x${height} px, scale=${scale.toFixed(2)})`);
                    } else {
            ...
            console.log(`  -> Added Code Block (${codeLines.length} lines)`);
        }
        // --- HTML Block (check for HTML tables) ---
            ...
            if (htmlContent.toLowerCase().startsWith('<table')) {
                console.log(`  -> Processing HTML Table with rowspan/colspan...`);
                try {
                ...
                console.log(`  -> Skipping non-table HTML block`);
            }
        }
