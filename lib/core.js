    ...
    try {
        ...
        <head>
            ...
            <style>
                ...
                #math-container { display: inline-block; font-size: ${displayMode ? '18px' : '14px'}; }
            </style>
        </head>
        <body>
        ...
        const renderResult = await page.evaluate(({ code, display }) => {
            try {
        ...
        // Screenshot the math element
        const element = await page.$('#math-container');
        if (!element) return null;
